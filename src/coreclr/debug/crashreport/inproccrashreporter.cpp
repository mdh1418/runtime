    ...
    void* context)
{
    ...
    if (context != NULL)
    {
        ...
        FormatHexValue(bp, sizeof(bp), static_cast<uint64_t>(ucontext->uc_mcontext->__ss.__fp));
...
#elif defined(__APPLE__) && defined(__aarch64__)
    return static_cast<uint64_t>(ucontext->uc_mcontext->__ss.__pc);
#elif defined(__x86_64__)
...
#elif defined(__APPLE__) && defined(__aarch64__)
    return static_cast<uint64_t>(ucontext->uc_mcontext->__ss.__sp);
#elif defined(__x86_64__)
