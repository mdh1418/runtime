...
public class Program
{
    ...
    {
        // Block here so the thread is visible in the crash report
    ...
    [DllImport("libc", EntryPoint = "abort")] static extern void abort();
    [DllImport("libc", EntryPoint = "memset")] static extern IntPtr memset(IntPtr d, int c, nuint n);
    [DllImport("libc", EntryPoint = "raise")] static extern int raise(int sig);
}
